<?php
    class FormHelpers
    {
        ...
        public static function createPass($name, $value, $attribs = null)
        {
            p('<input type="password" name="' . $name . '" value="' . $value . '"' . FormHelpers::optional($attribs) . ' />');
        }
        ...
        public static function sPost($key){
            if(isset($_POST[$key])){
                $dirty = $_POST[$key];
